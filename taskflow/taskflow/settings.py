...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-%7hc=o3kaq26i60&+#c54nrnxj%z%xqiw(k$r%fp==yql=za0t')

# SECURITY WARNING: don't run with debug turned on in production!
# Default to DEBUG=True for local development. Set the environment variable
# `DEBUG=False` in production to enable production security settings.
...
# WhiteNoise static files storage for efficient static serving in production
...
CSRF_COOKIE_HTTPONLY = False  # Must be False so JavaScript can read for X-CSRFToken header
